...
export default class TaskScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = { inputValue: '', dataSource: ds.cloneWithRows([]),
    };
    ...
    return (
      <View style={styles.container}>
        <View style={styles.formView}>
          <TextInput style={styles.inputForm} value={this.state.inputValue} onChangeText={this._handleTextChange} placeholder="Input todo" />
        ...
        <ListView
          ...
          renderRow={(rowData, sectionID, rowID) => {
            const handleDelete = () => this._handleDeleteButtonPress(rowID);
            return (
